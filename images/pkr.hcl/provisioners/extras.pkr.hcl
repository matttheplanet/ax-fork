  ...
  provisioner "shell" {
    ...
    inline = [
      ...
      "chmod 600 /home/op/.ssh/authorized_keys",
        ...
        "cd /tmp && git clone https://github.com/s0md3v/Arjun && cd Arjun && sudo pip3 install $(pip3 install --help 2>/dev/null | grep -q -- --break-system-packages && echo --break-system-packages) . && cd",
	...
	"nmap --version",
        ...
        "git clone https://github.com/xnl-h4ck3r/waymore.git /home/op/recon/ && cd /home/op/recon/waymore && sudo pip3 install $(pip3 install --help 2>/dev/null | grep -q -- --break-system-packages && echo --break-system-packages) . && sudo pip3 install $(pip3 install --help 2>/dev/null | grep -q -- --break-system-packages && echo --break-system-packages) -r requirements.txt",
        
        "echo 'Installing webscreenshot'",
        "pip3 install $(pip3 install --help 2>/dev/null | grep -q -- --break-system-packages && echo --break-system-packages) webscreenshot",
